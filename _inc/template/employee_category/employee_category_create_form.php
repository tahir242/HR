<!--begin::Form-->
<form id="create-form" class="form-horizontal" action="employee_category.php" method="post" enctype="multipart/form-data">
   <input type="hidden" name="action_type" value="CREATE">

   <div class="mb-3 row">
      <label for="Employee_Category" class="col-sm-3 col-form-label">Employee Category <span class="text-danger">*</span></label>
      <div class="col-sm-9">
          <input type="text" class="form-control" id="Employee_Category" name="Employee_Category" autocomplete="off" oninput="validateCharacters(this, 200)">
      </div>
   </div>
