<!--begin::Form-->
<form id="edit-form" class="form-horizontal" action="designation.php" method="post" enctype="multipart/form-data">
   ...
   <div class="mb-3 row">
      ...
      <div class="col-sm-9">
          <input type="text" class="form-control" id="Designation" name="Designation" value="<?php echo htmlspecialchars($row->Designation); ?>" autocomplete="off" oninput="validateCharacters(this, 200)">
      </div>
   </div>
