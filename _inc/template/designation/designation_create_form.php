<!--begin::Form-->
<form id="create-form" class="form-horizontal" action="designation.php" method="post" enctype="multipart/form-data">
   <input type="hidden" name="action_type" value="CREATE">

   <div class="mb-3 row">
      <label for="Designation" class="col-sm-3 col-form-label">Designation <span class="text-danger">*</span></label>
      <div class="col-sm-9">
          <input type="text" class="form-control" id="Designation" name="Designation" autocomplete="off" oninput="validateCharacters(this, 200)">
      </div>
   </div>
