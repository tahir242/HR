<!--begin::Form-->
<form id="edit-form" class="form-horizontal" action="Resignation_Type.php" method="post" enctype="multipart/form-data">
   <input type="hidden" name="action_type" value="UPDATE">
   <input type="hidden" name="Resignation_Type_ID" value="<?php echo $row->Resignation_Type_ID; ?>">

   <div class="mb-3 row">
      <label for="Resignation_Type" class="col-sm-3 col-form-label">Resignation_Type <span class="text-danger">*</span></label>
      <div class="col-sm-9">
          <input type="text" class="form-control" id="Resignation_Type" name="Resignation_Type" value="<?php echo htmlspecialchars($row->Resignation_Type); ?>" autocomplete="off" oninput="validateCharacters(this, 200)">
      </div>
   </div>
