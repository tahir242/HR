...
//Set Document Title
$document->setTitle("Employee Category(s)");
//ADD BODY CLASS
$document->setBodyClass('');

//Add Script and Style
$document->addScript('../assets/app/js/Controller/EmployeeCategoryController.js?v=1');
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?php if (user_role_id() == 1 || has_permission(1, 'create_employee_category')): ?>
