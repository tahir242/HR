...
if (user_group_id() != 1 && !has_permission(1, 'read_module')) {
    redirect(root_url() . '/'.APPDIRNAME.'/dashboard.php');
}

// Set Document Title
$document->setTitle("Module");
// ADD BODY CLASS
$document->setBodyClass('');

// Add Script and Style
$document->addScript('../assets/app/js/Controller/ModuleController.js?v=1');
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6">
                <?php if (user_group_id() == 1 || has_permission(1, 'create_module')) : ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            $hide_colums = "";
                            if (user_group_id() != 1 && !has_permission(1, 'modify_module')) {
                                $hide_colums .= "6,";
                            }
                        ?>
