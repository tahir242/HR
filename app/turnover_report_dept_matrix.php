...
$title = "Department Monthly Turnover Matrix";
$document->setTitle($title);
$document->addScript('../assets/app/js/Controller/TurnoverDeptMatrixController.js?v=4');
// Include ApexCharts
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div id="reportContainer" style="display: none;">
            ...
            <!-- Dynamic Table Grid -->
            <div class="card card-outline card-primary mb-4" style="page-break-inside: avoid;">
                <div class="card-header p-2">
                    <h3 class="card-title font-weight-bold text-uppercase" style="font-size: 15px; color: #0056b3;" id="matrixTitle">Department With Higher Turnover</h3>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table-striped table-hover mb-0" id="matrixTable">
                            <thead class="thead-light">
                                <tr id="matrixTheadRow">
            ...
            <!-- Chart -->
            <div class="card card-outline card-info mt-4" style="page-break-inside: avoid;">
                <div class="card-header p-2">
                    <h3 class="card-title font-weight-bold" style="font-size: 15px;">Turnover Trend & YTD</h3>
                </div>
                <div class="card-body p-2">
                    <div id="trendChart" style="width: 100%; min-height: 350px;"></div>
                </div>
            </div>
...
@media print {
    ...
    /* Make table compact for print */
    #matrixTable th, #matrixTable td { padding: 3px 5px !important; font-size: 11px !important; }
}
</style>
