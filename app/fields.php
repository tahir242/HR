...
if (user_group_id() != 1 && !has_permission(1, 'read_field')) {
    redirect(root_url() . '/'.APPDIRNAME.'/dashboard.php');
}

// Set Document Title
$document->setTitle("Rack");
// ADD BODY CLASS
$document->setBodyClass('');

// Add Script and Style
$document->addScript('../assets/app/js/Controller/FieldController.js?v=1');
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <!-- <h1 class="m-0">Rack</h1> -->
                </div>
                <div class="col-sm-6">
                <?php if (user_group_id() == 1 || has_permission(1, 'create_field')) : ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            $hide_colums = "";
                            if (user_group_id() != 1 && !has_permission(1, 'modify_field')) {
                                $hide_colums .= "6,";
                            }
                        ?>
