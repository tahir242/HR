...
docReady(function () {
    ...
    dt.dataTable({
        ...
        "serverSide": true,
        "dom": "rtip",
        "ajax": window.baseUrl + "/_inc/resignation_type.php",
        "order": [[1, "asc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
    ...
    $(document).delegate(".create-new", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: "Create New Resignation Type",
            url: window.baseUrl + "/_inc/resignation_type.php?action_type=CREATE"
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".edit", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: d.Resignation_Type,
            url: window.baseUrl + "/_inc/resignation_type.php?action_type=EDIT&Resignation_Type_ID=" + d.Resignation_Type_ID
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".delete", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: "Delete " + d.Resignation_Type,
            url: window.baseUrl + "/_inc/resignation_type.php?action_type=DELETE_FORM&Resignation_Type_ID=" + d.Resignation_Type_ID
        };
        openModal($scope);
    });
