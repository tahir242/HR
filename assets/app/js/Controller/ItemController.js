...
docReady(function () {
    ...
    dt.dataTable({
        ...
        "serverSide": true,
        "dom": "rtip",
        "ajax": window.baseUrl + "/_inc/item.php",
        "order": [[0, "asc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "columnDefs": [
            ...
            },
            {
                "targets": [6],
                'createdCell': function (td, cellData, rowData, row, col) {
                    $(td).attr('data-title', $("#list thead tr th:eq(6)").text());
                }
            },
        ],
        "aoColumns": [
    ...
    $(document).delegate(".create-new", "click", function (e) {
        ...
        let $scope = {
            ...
            url: window.baseUrl + "/_inc/item.php?action_type=CREATE"
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".edit", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: d.Item_Name,
            url: window.baseUrl + "/_inc/item.php?action_type=EDIT&Item_ID=" + d.Item_ID
        };
        openModal($scope);
    });
