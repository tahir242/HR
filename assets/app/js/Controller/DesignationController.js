...
docReady(function () {
    ...
    dt.dataTable({
        ...
        "serverSide": true,
        "dom": "rtip",
        "ajax": window.baseUrl + "/_inc/designation.php",
        "order": [[1, "asc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
    ...
    $(document).delegate(".create-new", "click", function (e) {
        ...
        let $scope = {
            ...
            url: window.baseUrl + "/_inc/designation.php?action_type=CREATE"
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".edit", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: d.Designation,
            url: window.baseUrl + "/_inc/designation.php?action_type=EDIT&Designation_ID=" + d.Designation_ID
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".delete", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: "Delete " + d.Designation,
            url: window.baseUrl + "/_inc/designation.php?action_type=DELETE_FORM&Designation_ID=" + d.Designation_ID
        };
        openModal($scope);
    });
