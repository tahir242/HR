...
docReady(function () {
    ...
    dt.dataTable({
        ...
        "serverSide": true,
        "dom": "rtip",
        "ajax": window.baseUrl + "/_inc/department.php",
        "order": [[0, "asc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
    ...
    $(document).delegate(".create-new", "click", function (e) {
        ...
        let $scope = {
            ...
            url: window.baseUrl + "/_inc/department.php?action_type=CREATE"
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".edit", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: d.Department,
            url: window.baseUrl + "/_inc/department.php?action_type=EDIT&Department_ID=" + d.Department_ID
        };
        openModal($scope);
    });
    ...
    $(document).delegate(".delete", "click", function (e) {
        ...
        let $scope = {
            size: "md",
            title: "Delete " + d.Department,
            url: window.baseUrl + "/_inc/department.php?action_type=DELETE_FORM&Department_ID=" + d.Department_ID
        };
        openModal($scope);
    });
