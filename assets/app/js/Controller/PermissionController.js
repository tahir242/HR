...
docReady(function () {
    ...
    dt.dataTable({
        ...
        "serverSide": true,
        "dom": "rtip",
        "ajax": window.baseUrl + "/_inc/permission.php",
        "order": [[0, "asc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
    ...
    $(document).delegate(".create-new", "click", function (e) {
        ...
        let $scope = {
            ...
            url: window.baseUrl + "/_inc/permission.php?action_type=CREATE"
        };
        openModal($scope);
        setTimeout(function () {
            $('#Sub_Module_ID').select2();
        }, 500);
    });
    ...
    $(document).delegate(".edit-permission", "click", function (e) {
        e.stopPropagation();
        e.preventDefault();
        ...
        let $scope = {
            size: "md",
            title: d.Permission,
            url: window.baseUrl + "/_inc/permission.php?action_type=EDIT&Permission_URN=" + d.Permission_URN
        };
        openModal($scope);
        setTimeout(function () {
            $('#Sub_Module_ID').select2();
