!(function (n, e) {
    ...
    return (function (n) {
        ...
        function (n, e, t) {
            ...
            function o(n) {
                return (
                    -1 !== navigator.userAgent.toLocaleLowerCase().indexOf(n)
                );
            }
            t.r(e);
            var i = (function () {
            ...
            function G() {
                var n =
                    arguments.length > 0 && void 0 !== arguments[0]
                        ...
                        : v.UNKONW;
                console.warn(
                    "You ar not allow to use DEVTOOL! 【type = ".concat(n, "】")
                ),
                ...
                if ((L(), F.url)) window.location.href = F.url;
                    ...
                    setTimeout(function () {
                        window.location.href =
                            "https://tackchen.gitee.io/404.html?h=".concat(
            ...
            function V() {
                "function" == typeof F.ondevtoolclose &&
                    !0 === F.clearIntervalWhenDevOpenTrigger &&
                    ((F.clearIntervalWhenDevOpenTrigger = !1),
                    console.warn(
                        "【DISABLE-DEVTOOL】clearIntervalWhenDevOpenTrigger ondevtoolclose"
                    ));
            }
            ...
            function Z() {
                ...
                window.addEventListener(
                    ...
                    function (n) {
                        ...
                        if (e === o || i(n, e) || r(n, e))
                            return (n.returnValue = !1), n.preventDefault(), !1;
                    },
                    !0
                ),
            ...
            function q(n, e) {
                n.addEventListener(e, function (n) {
                    return (
                        ((n = n || window.event).returnValue = !1),
                        n.preventDefault(),
                        !1
                    );
                });
            ...
            function en(n, e) {
                ...
                return (
                    (((n >> 16) + (e >> 16) + (t >> 16)) << 16) | (65535 & t)
                );
            }
            var tn = function (n) {
                return (function (n) {
                    for (
                        var e = "0123456789abcdef", t = "", o = 0;
                        o < 4 * n.length;
                        o++
                    )
                        t +=
                            e.charAt((n[o >> 2] >> ((o % 4) * 8 + 4)) & 15) +
                            e.charAt((n[o >> 2] >> ((o % 4) * 8)) & 15);
                    return t;
                })(
                    (function (n, e) {
                        (n[e >> 5] |= 128 << e % 32),
